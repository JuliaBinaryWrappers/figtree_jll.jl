...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import figtree_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("eeb7bb4a-9a32-53d0-9978-007222276d6f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "figtree", artifacts_toml) for e in artifacts["figtree"]]
...
if best_platform === nothing
    @debug("Unable to load figtree; unsupported platform $(triplet(platform_key_abi()))")
else
